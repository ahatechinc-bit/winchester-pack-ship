...
export default function Services() {
  return (
    <section id="services" className="py-24 px-6 bg-white dark:bg-zinc-950">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((s) => (
            <div
              key={s.title}
              className="group rounded-2xl border border-gray-200 bg-white p-6 flex flex-col gap-4 hover:border-amber-400/60 hover:bg-amber-50/40 transition-all duration-200 dark:border-zinc-800 dark:bg-zinc-900 dark:hover:border-amber-400/40 dark:hover:bg-zinc-800/60"
            >
